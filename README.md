...
👉 [**Download the latest trial release**](https://github.com/FellStreet/ClearWell-Standard-Trial/releases/download/ClearWell_Standard_Version_v1.0.xx/ClearWell_Standard-1.x.xx.zip)
...
1. Download the `.zip` from the [latest release](https://github.com/FellStreet/ClearWell-Standard-Trial/releases/download/ClearWell_Standard_Version_v1.0.xx/ClearWell_Standard-1.x.xx.zip).  
